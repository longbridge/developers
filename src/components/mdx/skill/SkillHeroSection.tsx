...
const LOCALE = {
  en: {
    hero: {
      ...
      chatgptLine:
        '<a class="skill-chatgpt-link" href="https://chatgpt.com/plugins/longbridge">ChatGPT</a> and <a class="skill-chatgpt-link" href="https://claude.ai/directory/longbridge">Claude</a> can install Longbridge directly — use <code>@longbridge</code> in ChatGPT, or the connector in Claude.',
  ...
  'zh-CN': {
    hero: {
      ...
      chatgptLine:
        '<a class="skill-chatgpt-link" href="https://chatgpt.com/plugins/longbridge">ChatGPT</a> 与 <a class="skill-chatgpt-link" href="https://claude.ai/directory/longbridge">Claude</a> 都能直接安装 Longbridge——在 ChatGPT 中用 <code>@longbridge</code> 调用，在 Claude 中启用连接器即可。',
      tabConnect: 'Connect AI',
      tabPrompt: '复制命令',
      tabChatGPT: 'ChatGPT',
      tabClaude: 'Claude',
  ...
  'zh-HK': {
    hero: {
      ...
      chatgptLine:
        '<a class="skill-chatgpt-link" href="https://chatgpt.com/plugins/longbridge">ChatGPT</a> 與 <a class="skill-chatgpt-link" href="https://claude.ai/directory/longbridge">Claude</a> 都能直接安裝 Longbridge——在 ChatGPT 中用 <code>@longbridge</code> 調用，在 Claude 中啟用連接器即可。',
      tabConnect: 'Connect AI',
      tabPrompt: '複製命令',
      tabChatGPT: 'ChatGPT',
      tabClaude: 'Claude',
