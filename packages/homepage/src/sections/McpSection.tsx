...
const LOCALE = {
  en: {
    ...
    desc: 'Open the <a href="https://chatgpt.com/plugins/longbridge">Longbridge ChatGPT App</a>, authorize, then use <code>@longbridge</code>. Other AI clients connect through hosted HTTP MCP with OAuth 2.1.',
  ...
  'zh-CN': {
    ...
    desc: '打开 <a href="https://chatgpt.com/plugins/longbridge">Longbridge ChatGPT App</a>，完成授权后用 <code>@longbridge</code> 调用。其他 AI 客户端可通过托管 HTTP MCP 和 OAuth 2.1 接入。',
    cta: 'MCP 文档',
  ...
  'zh-HK': {
    ...
    desc: '打開 <a href="https://chatgpt.com/plugins/longbridge">Longbridge ChatGPT App</a>，完成授權後用 <code>@longbridge</code> 調用。其他 AI 客戶端可透過託管 HTTP MCP 和 OAuth 2.1 接入。',
    cta: 'MCP 文件',
