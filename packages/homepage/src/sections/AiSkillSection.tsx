...
const LOCALE = {
  ...
  'zh-CN': {
    ...
    title2: '深度研究与智能交易',
    desc: '在 ChatGPT 中打开 <a href="https://chatgpt.com/plugins/longbridge">Longbridge ChatGPT App</a>，授权后用 <code>@longbridge</code> 调用。其他 AI 助手可通过 Longbridge Skill <a href="https://longbridge.com/screener">筛选股票</a>、解读财报、追踪内部人交易和下单。',
  ...
  'zh-HK': {
    ...
    title2: '深度研究與智能交易',
    desc: '在 ChatGPT 中打開 <a href="https://chatgpt.com/plugins/longbridge">Longbridge ChatGPT App</a>，授權後用 <code>@longbridge</code> 調用。其他 AI 助手可透過 Longbridge Skill <a href="https://longbridge.com/screener">篩選股票</a>、解讀財報、追蹤內部人交易和下單。',
