...
resp = ctx.finance_calendar(CalendarCategory.Split, "2024-01-01", "2024-03-31")
print(resp)
```
...
async def main() -> None:
    ...
    resp = await ctx.finance_calendar(CalendarCategory.Split, "2024-01-01", "2024-03-31")
    print(resp)
...
async function main() {
  ...
  const resp = await ctx.financeCalendar(CalendarCategory.Split, '2024-01-01', '2024-03-31')
  console.log(resp)
}
...
class Main {
    public static void main(String[] args) throws Exception {
        try (OAuth oauth = new OAuthBuilder("your-client-id").build(url -> System.out.println("Open to authorize: " + url)).get();
            ...
            var resp = ctx.financeCalendar(CalendarCategory.Split, "2024-01-01", "2024-03-31", null).get();
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let resp = ctx.finance_calendar(CalendarCategory::Split, "2024-01-01", "2024-03-31", None, None, None, None).await?;
    println!("{:?}", resp);
    Ok(())
}
```
...
int main() {
    OAuthBuilder("your-client-id").build(
        ...
        [](auto res) {
            ...
            CalendarContext ctx = CalendarContext::create(config);
            ctx.finance_calendar(CalendarCategory::Split, "2024-01-01", "2024-03-31", "", std::nullopt, std::nullopt, std::nullopt, [](auto resp) {
...
func main() {
	...
	defer c.Close()
	resp, err := c.FinanceCalendar(context.Background(), "Split", "2024-01-01", "2024-03-31", nil)
	if err != nil {
		log.Fatal(err)
	}
	fmt.Printf("%+v\n", resp)
