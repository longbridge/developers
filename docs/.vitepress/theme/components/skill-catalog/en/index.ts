...
export const locale: CatalogLocale = {
  skills: [
    ...
    },
    {
      ...
      desc: 'Real-time quotes, static reference, and valuation indices for HK/US/A-share/Singapore stocks — price, change, volume, PE/PB, turnover rate. View <a href="https://longbridge.com/markets" target="_blank" rel="noreferrer">live quotes on Longbridge</a>.',
