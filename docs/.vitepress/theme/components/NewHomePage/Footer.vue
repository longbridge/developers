...
const beianText = computed(() =>
  isCN.value && locale.value === 'zh-CN' ? `© ${new Date().getFullYear()} 粤 ICP 备 2025433117 号` : '',
)
  ...
  <footer v-if="!isCN" class="nhp-footer">
    <div class="nhp-footer-inner">
      ...
      <div class="nhp-footer-right">
        ...
        <a href="https://github.com/longbridge" class="nhp-github" target="_blank" aria-label="GitHub">
