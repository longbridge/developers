...
const CLI_COMMAND_MAP: Record<string, string> = {
  ...
  'ah-premium': '/docs/cli/market-data/ah-premium',
  anomaly: '/docs/cli/market-data/anomaly',
  'broker-holding': '/docs/cli/market-data/broker-holding',
  constituent: '/docs/cli/market-data/constituent',
  'market-status': '/docs/cli/market-data/market-status',
  'trade-stats': '/docs/cli/market-data/trade-stats',
  // Derivatives
  option: '/docs/cli/derivatives/option',
  warrant: '/docs/cli/derivatives/warrant',
  'short-positions': '/docs/cli/derivatives/short-positions',
  // Fundamentals
  company: '/docs/cli/fundamentals/company',
  consensus: '/docs/cli/fundamentals/consensus',
  'corp-action': '/docs/cli/fundamentals/corp-action',
  dividend: '/docs/cli/fundamentals/dividend',
  executive: '/docs/cli/fundamentals/executive',
  'finance-calendar': '/docs/cli/fundamentals/finance-calendar',
  'financial-report': '/docs/cli/fundamentals/financial-report',
  'forecast-eps': '/docs/cli/fundamentals/forecast-eps',
  'industry-valuation': '/docs/cli/fundamentals/industry-valuation',
  'institution-rating': '/docs/cli/fundamentals/institution-rating',
  'invest-relation': '/docs/cli/fundamentals/invest-relation',
  operating: '/docs/cli/fundamentals/operating',
  valuation: '/docs/cli/fundamentals/valuation',
  // Research
  shareholder: '/docs/cli/research/shareholder',
  // Content
