...
export default defineConfig(
  withMermaid({
    ...
    ['link', { rel: 'apple-touch-icon', href: 'https://assets.lbctrl.com/uploads/2e476c46-8bb9-4689-a800-54877351520e/app-icon.svg' }],
    ['link', { rel: 'icon', type: 'image/png', sizes: '192x192', href: 'https://assets.lbctrl.com/uploads/2e476c46-8bb9-4689-a800-54877351520e/app-icon.svg' }],
    ['link', { rel: 'icon', type: 'image/png', sizes: '512x512', href: 'https://assets.lbctrl.com/uploads/2e476c46-8bb9-4689-a800-54877351520e/app-icon.svg' }],
