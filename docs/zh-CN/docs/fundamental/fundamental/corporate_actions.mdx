...
<SDKLinks module="fundamental" klass="FundamentalContext" method="corp_action" />
...
async def main() -> None:
    ...
    resp = await ctx.corp_action("AAPL.US")
    print(resp)
...
async function main() {
  ...
  const resp = await ctx.corpAction('AAPL.US')
  console.log(resp)
}
...
class Main {
    public static void main(String[] args) throws Exception {
        try (OAuth oauth = new OAuthBuilder("your-client-id").build(url -> System.out.println("Open to authorize: " + url)).get();
            ...
            var resp = ctx.getCorpAction("AAPL.US").get();
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let resp = ctx.corp_action("AAPL.US").await?;
    println!("{:?}", resp);
    Ok(())
}
```
...
int main() {
    OAuthBuilder("your-client-id").build(
        ...
        [](auto res) {
            ...
            FundamentalContext ctx = FundamentalContext::create(config);
            ctx.corp_action("AAPL.US", [](auto resp) {
