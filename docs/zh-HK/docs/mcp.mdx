...
1. 開啟 **Plugins**
2. 搜尋 `longbridge`，或直接開啟 [Longbridge ChatGPT App](https://chatgpt.com/plugins/longbridge)
...
Longbridge 已作為官方連接器上架 [Claude](https://claude.ai/directory/longbridge) 應用目錄。
...
也可直接開啟 Claude - [Longbridge Connector](https://claude.ai/directory/longbridge)。
